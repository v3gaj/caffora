...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { cover: @gallery.cover, post_id: @gallery.post_id, subtitle: @gallery.subtitle, title: @gallery.title } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { cover: @gallery.cover, post_id: @gallery.post_id, subtitle: @gallery.subtitle, title: @gallery.title } }
